import{E as m,s as H,H as N,t as n,b as U,h as $,k as O,a as R,c as W,d as _,j as F,e as V,o as q}from"./codemirror-DnsGJnnT.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const Y="#e5c07b",E="#e06c75",J="#56b6c2",K="#ffffff",f="#abb2bf",b="#7d8799",z="#61afef",G="#98c379",P="#d19a66",Q="#c678dd",X="#21252b",k="#2c313a",L="#282c34",y="#353a42",Z="#3E4451",S="#528bff",ee=m.theme({"&":{color:f,backgroundColor:L},".cm-content":{caretColor:S},".cm-cursor, .cm-dropCursor":{borderLeftColor:S},"&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection":{backgroundColor:Z},".cm-panels":{backgroundColor:X,color:f},".cm-panels.cm-panels-top":{borderBottom:"2px solid black"},".cm-panels.cm-panels-bottom":{borderTop:"2px solid black"},".cm-searchMatch":{backgroundColor:"#72a1ff59",outline:"1px solid #457dff"},".cm-searchMatch.cm-searchMatch-selected":{backgroundColor:"#6199ff2f"},".cm-activeLine":{backgroundColor:"#6699ff0b"},".cm-selectionMatch":{backgroundColor:"#aafe661a"},"&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket":{backgroundColor:"#bad0f847"},".cm-gutters":{backgroundColor:L,color:b,border:"none"},".cm-activeLineGutter":{backgroundColor:k},".cm-foldPlaceholder":{backgroundColor:"transparent",border:"none",color:"#ddd"},".cm-tooltip":{border:"none",backgroundColor:y},".cm-tooltip .cm-tooltip-arrow:before":{borderTopColor:"transparent",borderBottomColor:"transparent"},".cm-tooltip .cm-tooltip-arrow:after":{borderTopColor:y,borderBottomColor:y},".cm-tooltip-autocomplete":{"& > ul > li[aria-selected]":{backgroundColor:k,color:f}}},{dark:!0}),te=N.define([{tag:n.keyword,color:Q},{tag:[n.name,n.deleted,n.character,n.propertyName,n.macroName],color:E},{tag:[n.function(n.variableName),n.labelName],color:z},{tag:[n.color,n.constant(n.name),n.standard(n.name)],color:P},{tag:[n.definition(n.name),n.separator],color:f},{tag:[n.typeName,n.className,n.number,n.changed,n.annotation,n.modifier,n.self,n.namespace],color:Y},{tag:[n.operator,n.operatorKeyword,n.url,n.escape,n.regexp,n.link,n.special(n.string)],color:J},{tag:[n.meta,n.comment],color:b},{tag:n.strong,fontWeight:"bold"},{tag:n.emphasis,fontStyle:"italic"},{tag:n.strikethrough,textDecoration:"line-through"},{tag:n.link,color:b,textDecoration:"underline"},{tag:n.heading,fontWeight:"bold",color:E},{tag:[n.atom,n.bool,n.special(n.variableName)],color:P},{tag:[n.processingInstruction,n.string,n.inserted],color:G},{tag:n.invalid,color:K}]),se=[ee,H(te)],I=`<!DOCTYPE html>
<html>
<head>
  <title>My Page</title>
</head>
...
p {
  ...
  font-size: 1.2rem;
}`,C=`// Write your JavaScript here
console.log('Hello from JavaScript!');

// Example: Add interactivity
document.querySelector('h1')?.addEventListener('click', function() {
  this.style.color = '#' + Math.floor(Math.random()*16777215).toString(16);
});`,w="html_editor_projects",T="html_editor_code";class ie{projectsData;constructor(){this.projectsData=this.loadProjects()}generateId(){return"proj_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}getDefaultCode(){return{html:I,css:B,js:C}}loadProjects(){try{const t=localStorage.getItem(w);if(t)return JSON.parse(t);const s=localStorage.getItem(T);if(s){const i=JSON.parse(s),o={id:this.generateId(),name:"Project 1",code:{html:i.html||I,css:i.css||B,js:i.js||C},createdAt:Date.now(),updatedAt:Date.now()};return{activeProjectId:o.id,projects:[o]}}}catch(t){console.error("Error loading projects:",t)}const e={id:this.generateId(),name:"Project 1",code:this.getDefaultCode(),createdAt:Date.now(),updatedAt:Date.now()};return{activeProjectId:e.id,projects:[e]}}saveProjects(){try{localStorage.setItem(w,JSON.stringify(this.projectsData))}catch(e){console.error("Error saving projects:",e)}}getProjects(){return this.projectsData.projects}getActiveProject(){return this.projectsData.projects.find(e=>e.id===this.projectsData.activeProjectId)}getActiveProjectId(){return this.projectsData.activeProjectId}setActiveProject(e){this.projectsData.projects.some(t=>t.id===e)&&(this.projectsData.activeProjectId=e,this.saveProjects())}createProject(e){const t=this.projectsData.projects.length+1,s={id:this.generateId(),name:e||`Project ${t}`,code:this.getDefaultCode(),createdAt:Date.now(),updatedAt:Date.now()};return this.projectsData.projects.push(s),this.projectsData.activeProjectId=s.id,this.saveProjects(),s}deleteProject(e){if(this.projectsData.projects.length<=1)return!1;const t=this.projectsData.projects.findIndex(s=>s.id===e);return t===-1?!1:(this.projectsData.projects.splice(t,1),this.projectsData.activeProjectId===e&&(this.projectsData.activeProjectId=this.projectsData.projects[0].id),this.saveProjects(),!0)}renameProject(e,t){const s=this.projectsData.projects.find(i=>i.id===e);return s?(s.name=t,s.updatedAt=Date.now(),this.saveProjects(),!0):!1}getCode(){const e=this.getActiveProject();return e?e.code:this.getDefaultCode()}saveCode(e){const t=this.getActiveProject();t&&(t.code=e,t.updatedAt=Date.now(),this.saveProjects())}clearCode(){const e=this.getActiveProject();e&&(e.code=this.getDefaultCode(),e.updatedAt=Date.now(),this.saveProjects())}clearAllData(){try{localStorage.removeItem(w),localStorage.removeItem(T),this.projectsData=this.loadProjects()}catch(e){console.error("Error clearing data:",e)}}}const x="html_editor_settings";class oe{settings;constructor(){this.settings=this.loadSettings()}loadSettings(){try{const e=localStorage.getItem(x);if(e)return JSON.parse(e)}catch(e){console.error("Error loading settings:",e)}return{darkMode:!0}}saveSettings(){try{localStorage.setItem(x,JSON.stringify(this.settings))}catch(e){console.error("Error saving settings:",e)}}isDarkMode(){return this.settings.darkMode}toggleDarkMode(){return this.settings.darkMode=!this.settings.darkMode,this.saveSettings(),this.settings.darkMode}renderSettingsPage(){return`
    ...
    `}}const A=2*60*60*1e3,D=3*60*60*1e3;class ne{storage;settings;editors=new Map;activeTab="html";autoSaveTimeout=null;isOnline=navigator.onLine;showingInterstitial=!1;constructor(){this.storage=new ie,this.settings=new oe}init(){this.render(),this.initEditors(),this.bindEvents(),this.updateOnlineStatus(),this.applyTheme(),this.checkAndShowAds(),this.setupAdIntervals()}renderProjectsList(){const e=this.storage.getProjects(),t=this.storage.getActiveProjectId();return e.map(s=>`
